      ...
      {userLocation && stations.length > 0 && (
        <div ref={resultsRef} className="container mx-auto px-3 md:px-4 py-8 md:py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 mb-12">
            <div className="h-[300px] md:h-[500px] lg:h-auto">
              <MapComponent
                stations={stations}
                center={userLocation}
                zoom={13}
            ...
            <div className="max-h-[400px] md:max-h-[500px] lg:max-h-[600px] overflow-y-auto pr-1 md:pr-2 space-y-3 md:space-y-4 scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent">
              <StationsList
                stations={stations}
